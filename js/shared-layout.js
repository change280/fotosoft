...
(function (global) {
  ...
  function renderHeader(activeNav, options) {
    ...
    var philosophyHref = onIndex ? '#philosophy' : 'index.html#philosophy';
    ...
    return '' +
      ...
      '    </a>' +
      '    <nav class="hidden lg:flex items-center gap-10 text-xs tracking-[0.2em] font-bold">' +
      '      <a href="' + philosophyHref + '" class="' + navClass('philosophy') + '">關於視丘</a>' +
  ...
  function renderFooter() {
    return '' +
      ...
      '        <li><a href="index.html#philosophy" class="hover:text-gallery-900 transition-colors">學院簡介</a></li>' +
  ...
  function mount(options) {
    ...
    if (header) header.innerHTML = renderHeader(opts.activeNav || '', opts);
